...
class Timer:
    ...
    def __init__(self, x:int, y:int) -> None:
        ...
        self.arrival_time = -2 # timer: if equal 0 the elevator should be on the floor, + 2 seconds
    ...
    def update_timer(self, time_past):
        """
    ...
    def drow_timer(self, screen, font):
        if self.if_timer_positive():
            screen.blit(font.render(str(round(self.arrival_time, 1)), True, (0, 0, 0)), (self.x, self.y))